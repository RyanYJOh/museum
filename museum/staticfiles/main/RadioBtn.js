window.onload = function radioBtn() {
    ...
    function clickMuseum(e) {
        document.getElementsByClassName('ans-mus')[0].style.display = 'flex';
        document.getElementsByClassName('ans-self')[0].style.display = 'none';
        // Profile 페이지에서 my bookmarks 있는 경우에만
        if (document.getElementsByClassName('ans-mus')[1]) {
            document.getElementsByClassName('ans-mus')[1].style.display = 'flex';
        } else {}
        if (document.getElementsByClassName('ans-self')[1]) {
            document.getElementsByClassName('ans-self')[1].style.display = 'none';
        } else{}
        
        document.getElementById('radio-mus-text').style.color = 'black';
        document.getElementById('radio-mus-text').style.fontWeight = '800';
    ...
    function clickSelf(e) {
        document.getElementsByClassName('ans-mus')[0].style.display = 'none';
        document.getElementsByClassName('ans-self')[0].style.display = 'flex';
        // Profile 페이지에서 my bookmarks 있는 경우에만
        if (document.getElementsByClassName('ans-mus')[1]) {
            document.getElementsByClassName('ans-mus')[1].style.display = 'none';
        } else {}
        if (document.getElementsByClassName('ans-self')[1]) {
            document.getElementsByClassName('ans-self')[1].style.display = 'flex';
        } else{}

        document.getElementById('radio-mus-text').style.color = 'grey';
        document.getElementById('radio-mus-text').style.fontWeight = '400';
