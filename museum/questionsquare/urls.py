...
urlpatterns = [
    ...
    path('delete-ques/<int:ques_others_id>', views.delete_ques_from_others, name="delete-ques-from-others"),
    ...
    path('delete-ans/<int:ans_others_id>', views.delete_ans_others, name="delete-ans-others"),
] 